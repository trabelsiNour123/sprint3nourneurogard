...
@Component({
  selector: 'app-healthcare-privider-management',
  imports: [],
  templateUrl: './healthcare-privider-management.html',
  styleUrl: './healthcare-privider-management.scss',
})
export class HealthcarePrividerManagement {
