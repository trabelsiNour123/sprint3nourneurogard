...
def main():
    ...
    try:
        ...
        print("=" * 70)
        print("\nNext steps:")
        print("  1. Review feature importance visualization: feature_importance.png")
        print("  2. Deploy model using: python app.py")
        print("  3. Test predictions using the /predict and /predict/batch endpoints")
        print("=" * 70 + "\n")
